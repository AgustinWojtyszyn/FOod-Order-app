-- Avoid rejecting remito refreshes because sourceOrders is descriptive payload.
-- p_order_ids remains the canonical order-id list sent by the frontend.
...
begin
  ...
  if v_requested_order_ids <> v_snapshot_order_ids then
